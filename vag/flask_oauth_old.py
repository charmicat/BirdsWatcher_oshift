...
def index():
    ...
    if g.user is not None:
        ...
        twitter_manager = TwitterApiAccess(CONSUMER_KEY, CONSUMER_SECRET, twitter_token[0],
                                           twitter_token[1], twitter)

        tweets = twitter_manager.get_timeline()
        uc = UnfollowCheck(g.user['screen_name'], twitter_manager)
